...
heightmap, _, endpos = parse_input()
# print(heightmap)
# print(startpos)
# print(endpos)
...
search_positions = [endpos]
minsteps_grid[endpos[1]][endpos[0]] = 0
...
while len(search_positions) > 0:
    ...
    for n in range(4):
        ...
        if height - dst_height > 1: continue
...
for y in range(grid_height):
    for x in range(grid_width):
        ...
        steps = minsteps_grid[y][x]
        if steps >= 0 and (min_steps < 0 or steps < min_steps): min_steps = steps
